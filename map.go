...
func main() {
	...
	fmt.Println("v_init_slice_len", len(v_slice))
	fmt.Println("v_init_slice_cap", cap(v_slice))
	...
	fmt.Println("make(map[int]string, 10)，After chagnes，v_mapByMake: ", v_mapByMake, len(v_mapByMake))
